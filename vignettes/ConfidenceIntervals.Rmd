...
## Printing of the results of each fold

Printing densities
```{r}
fancy <- TRUE
fancy <- FALSE
smet <-  ggmetern(edf %>% filter(name == "XY"), fancy) + 
...
#    stat_confidence_tern(breaks=c(50)) 
    facet_wrap(~Dataset) 
#    stat_confidence_tern(breaks=c(99,95,90)) 
...
The unaccountable spread of the results for iris and the non-inclusion of the tip for wine (I cannot see whether this is the case for iris too.) 
