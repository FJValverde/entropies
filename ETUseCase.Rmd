Use cases for the Entropy triangle
========================================================
...
for (i in 1:numFolds){
    for (m in models){
        ...
        results <- rbind(results, 
                         cbind(evaluate.confusionMatrix(trainCM), Fold=i, method=m, Phase="train"),
                         cbind(evaluate.confusionMatrix(testCM), Fold=i, method=m, Phase="test")
        )
...
for (i in 1:numFolds){
    for (m in models){
        ...
        # 5. Gather results for analysis
        results <- rbind(results, 
                         cbind(evaluate.confusionMatrix(trainCM, split=TRUE), 
                               Fold=i, method=m, Phase="train"
                               ),
                         cbind(evaluate.confusionMatrix(testCM, split=TRUE), 
