...
smet <-  ggmetern(totalEdf) + geom_point(mapping=aes(shape=name, color=withClass), size=3)
...
#edf1
thisEt <-  ggmetern(thisEdf) + geom_point(aes(shape=name, colour=withClass), inherit.aes=TRUE)
